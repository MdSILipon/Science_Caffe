<?php
	...
	$con=mysqli_connect("localhost","root","","science_caffe") or die ("Connection was not established");
		...
		function get_posts(){
			...
			while($row_posts=mysqli_fetch_array($run_posts)){
				...
				<h3><a herf='user_profile.php?user_id=$user_id' style='color:blue;'>$user_name</a></h3>
				<h3>$post_title</h3>
				<p>$post_date</p>
				<p>$content</p>
		...
		function single_post(){
			...
			$row_posts=mysqli_fetch_array($run_posts);
				...
				<textarea cols='50' rows='5' name='comment' style='padding:8px;border:1px solid black;border-radius:5px;font-weight:bold;margin-top:5px;'>
				</textarea><br/>
		...
		//function for getting categogy or topics
		function get_Cats(){
